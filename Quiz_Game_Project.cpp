...
public:
	...
	void vdgames()
	{
		...
		cout << "\t Q3. What is the first game to sell more than 100M copies ? \n\t A. Super Mario Bros	 \n \t B. World of Warcraft \n\t C. Grand Theft Auto: The Lost and Dammned \n\t D. Minecraft" << endl;
		cin >> ch2;
		if (ch2 == 'b' || ch2 == 'B')
		{
			x = x + 10;
		...
		cout << "\t Q6. The first version of Call of Duty was released in ? \n\t A. 2006 \n\t B. 2000 \n\t C. 2004 \n\t D. 2003" << endl;
		cin >> ch2;
		if (ch2 == 'a' || ch2 == 'A')
		{
			x = x + 10;
		...
		cout << " \t Q7. What is the best selling video game console of all-time ? \n\t A. Play Station 2 \n\t B. Nintendo DS \n\t C. Xbox 360 \n\t D. Game boy" << endl;
		cin >> ch2;
		if (ch2 == 'a' || ch2 == 'A')
		{
			x = x + 10;
		...
		cout << "\t Q8. Valorant is created by which Organisation \n\t A. Epic Games \n\t B. Ubisoft \n\t C. Valve \n\t D. Riot" << endl;
		cin >> ch2;
		if (ch2 == 'd' || ch2 == 'D')
		{
			x = x + 10;
